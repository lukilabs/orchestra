...
class MCPOrchestra:
    ...
    async def connect(
        ...
        *,
        ...
        initialize_timeout: Optional[float] = None,  # Timeout for session.initialize()
    ) -> None:
        """
        ...
        if initialize_timeout is None or initialize_timeout < 0:
            initialize_timeout = 5.0 if sse_url else 1.0
